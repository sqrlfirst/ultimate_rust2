...
//!A pumpkin is a vernacular and typical term for a cultivated orange and round
//! mature winter squash of species and varieties in the genus Cucurbita that
//! has culinary and cultural significance[1][2] but there is no agreed upon
//! botanical or scientific meaning, and depending on the vernacular, its color
//! and shape may vary.[3] The term pumpkin is sometimes used interchangeably
//! with "squash" or "winter squash", and is commonly used for some cultivars of
//!  Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima, Cucurbita
//! moschata, and Cucurbita pepo
